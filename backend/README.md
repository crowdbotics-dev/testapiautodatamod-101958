...
## Project Structure
    ...
    ├── testapiautodatamod_101958  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_101958`
...
2. Clone this repo and `cd testapiautodatamod_101958`
